...
export default function DirectorPage() {
  return (
    <section className={styles.section}>
      ...
      <main>
        <h2 className={styles.name}>이임순 (센터장 및 상담전문가)</h2>
        <ul className={styles.mainList}>
          <li>• 숙명여자대학교 일반대학원 교육학 박사(상담 및 생활지도 전공)</li>
          ...
          <li>• 현) 한국방송통신대학교 유아교육과/ 청소년교육과 외래강사</li>
          <br />
        </ul>
